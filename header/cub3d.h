...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/07/29 07:16:24 by paroonag          #+#    #+#             */
/*   Updated: 2022/07/30 10:26:33 by paroonag         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				apply_dda(t_info *cub, t_ray *ray);

void				distance_wall(t_player *p, t_ray *ray);
void				height_wall(t_info *cub, t_ray *ray);
void				te_x_wall(t_player *player, t_ray *ray);
void				te_y_wall(t_info *cub, t_ray *ray, int x);
